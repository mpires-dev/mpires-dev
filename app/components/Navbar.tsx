          ...
          <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-4">
            {navLinks.map((link) => (
              <Link
                ...
                className={clsx(
                  "text-sm font-medium py-2 border-b border-white/5 last:border-0 transition-colors",
