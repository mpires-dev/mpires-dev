...
export const alt = "Projects — Matheus Pires";
...
export default function OgImage() {
  return new ImageResponse(
    (
      ...
      >
        <div style={{ position: "absolute", inset: 0, backgroundImage: "radial-gradient(circle at 80% 20%, rgba(255,255,255,0.04) 0%, transparent 55%)" }} />
        ...
        <div style={{ fontSize: "22px", color: "#71717a", maxWidth: "560px", lineHeight: 1.5 }}>
          Real-world products built with TypeScript, React, and AI — from concept to production.
        </div>
